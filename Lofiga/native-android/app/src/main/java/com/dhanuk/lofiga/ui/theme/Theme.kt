...
val DarkHairline = Color(0xFF5C5E6B)
val DarkInk      = Color(0xFFE6E1E9)
val DarkGray     = Color(0xFF9EA0AA)
val DarkGrayLt   = Color(0xFF9EA0AA)
...
private val LofigaDarkColorScheme = darkColorScheme(
    ...
    outline = DarkHairline,
    outlineVariant = Color(0xFF5C5E6B),
